...
public class DateFormatTool {
	...
	*/
	...
	public static String convertDateMMddyy (String dateString)
	{
		String newDate = new String();
		try
		{
			...
			newDate = sdf.format(d);
			//Logger.getLogger("oas").debug("convertDateMMddyy before:"+dateString+",after:"+newDate);
		}
		catch(Exception ex)
		{
			Logger.getLogger("oas").debug("Exception in convertDateMMddyy  :"+ex);
		}

...
<%
	//Logger.getLogger("oasweb").debug("Enter appStatusDeclined2.jsp");
		...
		<td valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="0">
          <tr>
                ...
                <TR>
                 ...
                 <TR align="left" valign="middle" bgcolor="#FFFFFF">
                  <TD valign="top"><TABLE cellSpacing=1 cellPadding=0 width=99% border=0>
                      <TBODY>
                        <TR class="form">
                          <TD width=536 height="20" valign="top" class="formtext"><p><strong><%= fn %>&nbsp; <%= ln %></strong> your application was received on <%= ad %> but we were unable to approve it . </p>
                            <p>You will receive a correspondence detailing the reasons why shortly. </p><br>
                            </TD>
                          </TR>
                      </TBODY>
                    </TABLE>
			...
			<!-- Start welcome box content -->
           	...
           	<dynjsp:DynamicContent  page="APPSTDEC" pageLocation="a1"/>     
					 <!-- End Dynamic Content -->
           </td>
          </tr>
        </table></td>
...
<%
	//Logger.getLogger("oasweb").debug("Exit appStatusDeclined2.jsp");
%>
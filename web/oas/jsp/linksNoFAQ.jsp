...
<!-- Start links content -->  
	<table width="190" border="0" cellpadding="0" cellspacing="0">
		  ...
		  <tr>
             ...
             <tr>
               <td rowspan="18" bgcolor="#999999"><img src="images/blank.gif" width="1" height="1"></td>
               <td bgcolor="#CCCCCC" height="2"><img src="images/blank.gif" width="1" height="1"></td>
               <td width="1" rowspan="18" bgcolor="#999999"><img src="images/blank.gif" width="1" height="1"></td>
             </tr>
             <tr>
...
<!-- End links content -->
<%
	//Logger.getLogger("oasweb").debug("Exit links.jsp");
%>
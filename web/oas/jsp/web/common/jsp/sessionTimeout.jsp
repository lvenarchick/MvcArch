...
<%
	//Logger.getLogger("oasweb").debug("Enter sessionTimeout.jsp");
	...
	<td valign="top">
	    ...
	    <tr>
			<td width="74%" valign="top">
		        ...
		        <tr valign="top">
		        <td>
		        	<h1>Your session has timed out!<span class="excitingbluebig"></span></h1>
		        	<br><br><br>
		        </td>
		        </tr>
		        </table>
				...
				<td colspan="2">
					...
					<tr>
						<td>
							...
							<p class="excitingblue">&nbsp;&nbsp;&nbsp;We&rsquo;re sorry. Due to inactivity, your current session has expired for your protection.</p>
							<br>
					...
					<tr>
						<td>			
							<blockquote><p class="data" height="25" valign="top">&nbsp;&nbsp;&nbsp;<a href="https://onlineaccountservices.appliedbank.com" > Click here to create a new session and sign in.</a></p><blockquote>
						</td>	
					</tr>
					</table>	
				</td>
...
<%
	//Logger.getLogger("oasweb").debug("Exit sessionTimeout.jsp");
%>

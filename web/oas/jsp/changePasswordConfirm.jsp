...
<%
	//Logger.getLogger("oasweb").debug("Enter changePasswordConfirm.jsp");
...
response.addHeader("X-Frame-Options", "DENY");
    ...
    String accNumber = custInfo.getSelectedAccount();
   	...
   	if(pppEligiblityVO != null)
   	{
   		...
   		//Logger.getLogger("oas").debug("changePasswordConfirm.jsp::["+pppEligibility+"],["+pppAccountNumber+"],["+pppExpDate+"]");
   	}
%>
<html>
...
function logoff()
{
	document.getElementById("changePasswordConfirmForm").action="logoff.do";
	document.getElementById("changePasswordConfirmForm").submit();
}

function submitPPPEnrollment()
{
	document.getElementById("changePasswordConfirmForm").action="pppEnrollmentInt.do";
	document.getElementById("changePasswordConfirmForm").submit();
}

function doPayOnlineNow()
{
	document.getElementById("changePasswordConfirmForm").action="oaspay.do";
	document.getElementById("changePasswordConfirmForm").submit();
}

function doCustomerService()
{
	document.getElementById("changePasswordConfirmForm").action="customerService.do";
	document.getElementById("changePasswordConfirmForm").submit();
}
</script>
...
<center>
<form name="changePasswordConfirmForm" id="changePasswordConfirmForm" autocomplete="nope" method="post">
          ...
          <tr>
            <td width="74%" valign="top"><TABLE width=544 border=0 cellpadding="0" cellspacing="0">
              <TBODY>
                ...
                <TR>
                  <TD width="37%" height="5" valign="top"><img src="images/blank.gif" width="1" height="1"></TD>
                  </TR>
                <tr>
                ...
                <tr>
                  <td height="20" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="25" colspan="2" class="data"><h2 align="center">Thank You. </h2>
                        <p align="center"> Your password has been changed. </p>
                        <p align="center">&nbsp;</p></td>
                      </tr>
            ...
            <dynjsp:DynamicContent  page="CHGPWDCNF" pageLocation="a1"/>     
			 <!-- End Dynamic Content -->
...
<%
	//Logger.getLogger("oasweb").debug("Exit changePasswordConfirm.jsp");
%>
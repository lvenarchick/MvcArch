			...
			<td width="74%" valign="top">
				...
				<tr align="center">
					<td >
				    	...
				    	<p style="font-family: Arial, Helvetica, sans-serif;font-size: 10pt;color: #000000;font-weight: bold;">&nbsp;</p>
						<p style="font-family: Arial, Helvetica, sans-serif;font-size: 10pt;color: #000000;font-weight: bold;">Once you have enabled JavaScript please <a href="https://onlineaccountservices.appliedbank.com">click here</a>. </p>
					</td>
				</tr>
